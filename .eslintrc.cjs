...
module.exports = {
  ...
  ignorePatterns: [
    "src/generated/**",
    "src/graphql/codegen_plugins/dist/*.js",
  ...
  rules: {
    ...
    "@typescript-eslint/no-explicit-any": process.env.DISABLE_ABC_LINT
      ? "off"
      : "error",
    ...
    "react-hooks/exhaustive-deps": process.env.DISABLE_ABC_LINT
      ? "off"
      : "error",
